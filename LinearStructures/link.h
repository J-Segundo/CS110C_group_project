...
private:
  static Link<E>* freelistSL; // Reference to freelist head. static means freelistSL is
  // shaired with all object of a single type
public:
  ...
  void* operator new(size_t) { // Overloaded new operator
    if (freelistSL == NULL) return ::new Link; // Create space using the actual new operator (::new)
